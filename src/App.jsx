    ...
    <>
      <div id='tn'>
        <a href='#' className='logoes'>
          <img
            src='https://www.pngplay.com/wp-content/uploads/9/Facebook-Logo-Transparent-Free-PNG.png'
            alt='facebook logo'
            width={26}
          />
        </a>
        <a href='#' className='logoes'>
          <img
            src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRq4yMAtzwb7DARCqj85yS9rRqZn_2TdKR0zA&s'
            alt='instagram logo'
            width={21}
          />
        </a>
        ...
        <a href='#' className='logoes'>
          <img
            src='https://cdn.freebiesupply.com/logos/large/2x/pinterest-1-logo-black-and-white.png'
            alt='pinterest logo'
            width={25}
          />
        </a>
      ...
      <div id='footer'>
        <table id="ft">
          ...
          <tr>
            ...
            <td>Prices Drop</td>
            <td>Delivery</td>
            <td>Stylish Online Store 123 Main</td>
          </tr>
          <br />
          <tr>
            <td>Our Blog</td>
